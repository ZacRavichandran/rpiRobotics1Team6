...
class lane_controller_logging(object):
    def __init__(self):
    ...
    def cbPose(self,lane_pose_msg):
        rospy.loginfo("lane_controller_logging node recieved callback")
...
if __name__ == "__main__":
    rospy.init_node("lane_controller_logging",anonymous=False)
    lane_control_node = lane_controller_logging()
    rospy.spin()

...
For more info on algorithm and parameters please refer to the google doc:
 https://drive.google.com/open?id=0B49dGT7ubfmSX1k5ZVN1dEU4M2M
    ...
    """
    def __init__(self):
        self.node_name = "Lane Filter Logging"
        self.active = True
    ...
    def processSegments(self,segment_list_msg):
        ...
        # logging
        rospy.loginfo("Lane_fileter_log_node processing callback")
...
if __name__ == '__main__':
    rospy.init_node('lane_filter_logging',anonymous=False)
    lane_filter_node = LaneFilterLoggingNode()

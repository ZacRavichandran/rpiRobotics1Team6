...
class WheelsDriverLoggingNode(object):
    def __init__(self):
    ...
    def cbWheelsCmd(self,msg):
        if self.estop:
            ...
            return
        # log
        rospy.loginfo("wheels_driver_logging_node received callback")
...
if __name__ == '__main__':
    ...
    rospy.init_node('wheels_driver_logging_node', anonymous=False)
    # Create the DaguCar object
    node = WheelsDriverLoggingNode()

...
class InverseKinematicsNodeLogging(object):
    def __init__(self):
    ...
    def car_cmd_callback(self, msg_car_cmd):
        # logging
        rospy.loginfo("inverse_kinematics_logging_node callback received")
...
if __name__ == '__main__':
    rospy.init_node('inverse_kinematics_logging_node', anonymous=False)
    inverse_kinematics_node = InverseKinematicsNodeLogging()
    rospy.spin()
